...
export class AdminConfigController {
  ...
  // Domains
  @Get('domains')
  @ApiOperation({ summary: 'List all domain definitions' })
  listDomains() {
    return this.svc.listDomains();
  }

  @Post('domains')
  @ApiOperation({ summary: 'Create a domain definition' })
  createDomain(@Body() dto: CreateDefinitionDto) {
    return this.svc.createDomain(dto);
  }

  @Put('domains/:id')
  @ApiOperation({ summary: 'Update a domain definition' })
  updateDomain(@Param('id') id: string, @Body() dto: UpdateDefinitionDto) {
    return this.svc.updateDomain(id, dto);
  }

  @Delete('domains/:id')
  @ApiOperation({ summary: 'Soft-delete a domain definition' })
  deleteDomain(@Param('id') id: string) {
    return this.svc.deleteDomain(id);
  }

  // Seams
  @Get('seams') listSeams() {
    return this.svc.listSeams();
  }

  @Post('seams')
  @ApiOperation({ summary: 'Create a relationally-linked seam definition' })
  createSeam(@Body() dto: CreateSeamDto) {
    return this.svc.createSeam(dto);
  }

  @Put('seams/:id')
  @ApiOperation({ summary: 'Update a seam definition and its domain associations' })
  updateSeam(@Param('id') id: string, @Body() dto: UpdateSeamDto) {
    return this.svc.updateSeam(id, dto);
  }

  @Delete('seams/:id') deleteSeam(@Param('id') id: string) {
    return this.svc.deleteSeam(id);
  }

  // Archetypes
  @Get('archetypes') listArchetypes() {
    return this.svc.listArchetypes();
  }
  @Post('archetypes') createArchetype(@Body() dto: CreateDefinitionDto) {
    return this.svc.createArchetype(dto);
  }
  @Put('archetypes/:id') updateArchetype(
    @Param('id') id: string,
    @Body() dto: UpdateDefinitionDto,
  ) {
    return this.svc.updateArchetype(id, dto);
  }
  @Delete('archetypes/:id') deleteArchetype(@Param('id') id: string) {
    return this.svc.deleteArchetype(id);
  }
  ...
  createProbeQuestion(@Body() dto: CreateProbeQuestionDto) {
    return this.svc.createProbeQuestion(dto);
  }
  ...
  deleteProbeQuestion(@Param('id') id: string) {
    return this.svc.deleteProbeQuestion(id);
  }

  // Void Codes
  @Get('void-codes')
  listVoidCodes() {
    return this.svc.listVoidCodes();
  }
  ...
  updateVoidCode(
    @Param('id') id: string,
    @Body() dto: UpdateDefinitionDto & { severity?: string },
  ) {
    return this.svc.updateVoidCode(id, dto);
  }

  @Delete('void-codes/:id')
  deleteVoidCode(@Param('id') id: string) {
    return this.svc.deleteVoidCode(id);
  }
}
