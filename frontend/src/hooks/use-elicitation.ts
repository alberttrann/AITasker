...
export function handleElicitationError(err: any): {
  ...
  return { message: message || 'Something went wrong. Please try again.', isSubscriptionError: false };
}
...
export const VOID_DESCRIPTIONS: Record<string, string> = {
  ...
  UNCLEAR_SUCCESS_METRIC:    'Success criteria are vague. How will you measure success?',
  TIMELINE_UNREALISTIC:      'The timeline described may not be realistic for AI delivery.',
  INTEGRATION_UNCLEAR:       'Integration points with existing systems are not clearly defined.',
  DATA_AVAILABILITY_UNKNOWN: 'Data availability and quality are not specified.',
  UNCLEAR_USER_PERSONA:      'The target users and their needs are not clearly defined.',
};

export const PROBES: Record<string, { q1: string; q2: string; q3: string; q4: string }> = {
  '1': { q1: 'Roughly how many people will search or ask questions per day?',
  ...
  '2': { q1: 'Roughly how many users will see recommendations, and how often?',
  ...
  '3': { q1: 'Roughly how many items need classifying per day?',
  ...
  '4': { q1: 'Roughly how much content needs generating per day/week?',
  ...
  '5': { q1: 'How far ahead are you trying to predict, and how often do you need a new prediction?',
  ...
  '6': { q1: 'Roughly how many items (images/audio/video) need processing per day?',
