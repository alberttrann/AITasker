    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 bg-surface-base overflow-hidden relative select-none shrink-0 min-w-0">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center relative z-10 min-w-0">
        <div className="relative z-10 text-center max-w-2xl w-full flex flex-col items-center shrink-0 min-w-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full shrink-0">
            <button
              onClick={() => navigate(-1)}
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-cream border-2 border-primary-light hover:bg-primary-bg text-primary-dark font-headline font-bold py-4 px-8 rounded-full transition-all duration-300 shadow-sm hover:shadow-teal-glow active:scale-95 min-h-[72px] shrink-0"
            >
            ...
            <button
              onClick={() => navigate('/')}
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-accent to-accent-light text-primary-dark font-headline font-extrabold py-4 px-8 rounded-full transition-all duration-300 shadow-accent-glow hover:brightness-110 active:scale-95 min-h-[72px] shrink-0"
            >
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
