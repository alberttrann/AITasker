                ...
                <div className="relative ml-3">
                  ...
                  >
                    <div className="relative">
                      ...
                      {rawRole !== 'TECH_TEAM' && rawRole !== 'ADMIN' && (
                        <div className={`absolute -bottom-2 left-1/2 -translate-x-1/2 px-2 py-0.5 text-[9px] font-headline font-extrabold tracking-wider rounded-full border-2 border-surface shadow-sm whitespace-nowrap pointer-events-none ${isPro
