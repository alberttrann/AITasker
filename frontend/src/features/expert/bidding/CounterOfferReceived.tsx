...
export default function CounterOfferReceived() {
  ...
  const canRevise =
    bid.nextActionBy === 'EXPERT' &&
    bid.technicalReview?.status === 'REVISION_REQUESTED' &&
    bid.currentOffer?.proposerRole === 'EXPERT';
  ...
  return (
    <div className="mx-auto w-full max-w-[900px] space-y-6">
      ...
      {bid.negotiationState === 'AWAITING_TECH_REVIEW' && bid.technicalReview?.status === 'PENDING' ? <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">Tech Team is reviewing the current technical scope.</div> : null}
