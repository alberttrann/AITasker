  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-6 py-12 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <Button variant="primary" onClick={() => navigate('/expert/subscriptions/plans')} className="flex items-center gap-2 px-6 font-bold shadow-emerald-glow hover:brightness-105 transition-all">
          <Sparkles size={18} />
          View Premium Plans
        </Button>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className={`rounded-2xl border p-8 shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden ${
          ...
          {isPro ? (
            ...
            <div className="flex flex-col md:items-end gap-4 md:ml-0">
              <Button onClick={() => navigate('/expert/subscriptions/plans')} className="flex items-center gap-2 !bg-white hover:!bg-slate-100 !text-slate-900 font-bold border-none shadow-sm transition-all hover:-translate-y-1 hover:shadow-white/10">
                <Sparkles size={16} />
                View Plans
              </Button>
            </div>
