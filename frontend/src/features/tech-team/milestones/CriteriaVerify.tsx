      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label htmlFor="textarea-criterion-verification-comment" className="block text-xs font-bold text-slate-500 uppercase tracking-wider">
            Technical Verification Comment (Optional)
          </label>
          <textarea
            ...
            placeholder="Add technical evidence for this sign-off, such as test results or staging verification..."
        ...
        <div className="flex justify-end gap-2 pt-2">
          <Button
            ...
            id="btn-tech-cancel-criterion-verification"
          >
            Cancel
          </Button>
          <Button
            ...
            id="btn-tech-confirm-criterion-verification"
          >
            {verifyMutation.isPending ? "Verifying..." : "Tech Sign-off"}
          </Button>
        </div>
      </div>
    </Modal>
