...
import { Loader2, FileText, PlayCircle, ArrowRight, Clock } from "lucide-react";
      ...
      <div className="mb-8">
        ...
        {isLoadingProjects ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-2 h-auto bg-white border border-slate-200 rounded-[20px] p-8 flex flex-col items-center justify-center text-center min-h-[240px]">
