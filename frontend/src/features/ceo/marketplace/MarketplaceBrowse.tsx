...
import { Loader2, Search, Briefcase, ArrowRight, MessageSquare, CreditCard, Clock, CheckCircle } from 'lucide-react';
...
export default function MarketplaceBrowse() {
  ...
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'SERVICES' | 'PURCHASES'>(() => {
