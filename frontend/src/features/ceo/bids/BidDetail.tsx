...
import BidDecisionConfirm from './BidDecisionConfirm';
    ...
    return (
      <div className="py-24 text-center space-y-4">
        ...
        <div className="flex justify-center gap-3">
          <Button variant="secondary" onClick={() => refetch()} id={`btn-retry-bid-${bidId}`}>Retry</Button>
          <Button variant="ghost" onClick={() => navigate(`/ceo/project/${projectId}/bids`)} id={`btn-back-bids-${bidId}`}>Back</Button>
        </div>
      </div>
    );
  }
      ...
      {canDecide && (
        <div className="space-y-4 pt-4 border-t border-[#E2E8F0]">
          ...
          {showCounterOffer && (
            <BidDecisionConfirm 
              bidId={bidId}
              onSuccess={() => setShowCounterOffer(false)}
          ...
          <div className="flex items-center justify-end gap-3">
            {!showCounterOffer && !bidAny?.negotiatedPriceVnd && (
              <Button
                ...
                id={`btn-show-counter-offer-${bidId}`}
              >
